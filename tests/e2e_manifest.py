...
CLI_COVERAGE: dict[str, tuple[str, str]] = {
    ...
    "kdbg struct": (LIVE, ""),
    "kdbg ps": (LIVE, ""),
    "kdbg vad": (LIVE, "PDB-backed bounded user VAD lookup/map"),
    "kdbg vad-extract": (LIVE, "one-stop immutable process-VAD byte artifact"),
    "kdbg token": (LIVE, "exact-PDB primary token evidence"),
    "kdbg handles": (LIVE, "validated handle-table root and fail-closed entry support"),
    "kdbg object": (LIVE, "exact-PDB object-header evidence from a caller-proven pointer"),
    "kdbg capture": (LIVE, "one-stop immutable process/system capture"),
    "kdbg capture diff": (LIVE, "offline diff of live-generated capture artifacts"),
    "kdbg threads": (LIVE, "validated ETHREAD ownership and scheduler metadata"),
    "kdbg thread-triage": (LIVE, "one bounded complete-or-explicitly-partial global scheduler view"),
    "kdbg thread-baseline": (LIVE, "explicit complete host-side ETHREAD baseline"),
    "kdbg thread-diff": (LIVE, "bounded one-stop ETHREAD delta against an explicit baseline"),
    ...
    "kdbg attach": (LIVE, ""),
    "kdbg bp-intent-add": (LIVE, "offline durable intent storage and explicit application"),
    "kdbg bp-intents": (LIVE, "offline durable intent storage and explicit application"),
    "kdbg bp-intent-rm": (LIVE, "offline durable intent storage and explicit application"),
    "kdbg detach": (LIVE, "asserts the guest is not left paused"),
    "kdbg resume": (LIVE, ""),
    "kdbg user-lm": (LIVE, ""),
    "kdbg user-symbols": (LIVE, ""),
    "kdbg search": (EXCLUDED, "offline exact-PE discovery is covered by local static-search integration and CLI unit tests"),
    "kdbg read-va": (LIVE, ""),
...
MCP_COVERAGE: dict[str, tuple[str, str]] = {
    ...
    "kdbg_struct": (LIVE, ""),
    "kdbg_ps": (LIVE, ""),
    "kdbg_vad": (LIVE, "PDB-backed bounded user VAD lookup/map"),
    "kdbg_vad_extract": (LIVE, "one-stop immutable process-VAD byte artifact"),
    "kdbg_token": (LIVE, "exact-PDB primary token evidence"),
    "kdbg_handles": (LIVE, "validated handle-table root and fail-closed entry support"),
    "kdbg_object": (LIVE, "exact-PDB object-header evidence from a caller-proven pointer"),
    "kdbg_capture": (LIVE, "one-stop immutable process/system capture"),
    "kdbg_capture_diff": (LIVE, "offline diff of live-generated capture artifacts"),
    "kdbg_threads": (LIVE, "validated ETHREAD ownership and scheduler metadata"),
    "kdbg_thread_triage": (LIVE, "bounded global scheduler rankings with explicit scope"),
    "kdbg_thread_baseline": (LIVE, "explicit complete host-side ETHREAD baseline"),
    "kdbg_thread_diff": (LIVE, "bounded one-stop ETHREAD delta against an explicit baseline"),
    "kdbg_triage": (LIVE, "one bounded coherent process-research snapshot"),
    "kdbg_lm": (LIVE, ""),
    "kdbg_base_refresh": (LIVE, ""),
    "kdbg_attach": (LIVE, ""),
    "kdbg_bp_intent_add": (LIVE, "offline durable intent storage and explicit application"),
    "kdbg_bp_intents": (LIVE, "offline durable intent storage and explicit application"),
    "kdbg_bp_intent_remove": (LIVE, "offline durable intent storage and explicit application"),
    "kdbg_detach": (LIVE, "asserts the guest is not left paused"),
    "kdbg_resume": (LIVE, ""),
    "kdbg_user_lm": (LIVE, ""),
    "kdbg_user_symbols_load": (LIVE, ""),
    "kdbg_search": (EXCLUDED, "offline exact-PE discovery is covered by local static-search integration and MCP unit tests"),
    "kdbg_read_va": (LIVE, ""),
    "kdbg_regs": (LIVE, ""),
    "kdbg_mem": (LIVE, ""),
    "kdbg_stack": (LIVE, ""),
...
CLI_EXCLUSION_UNIT_TESTS: dict[str, str] = {
    ...
    "kdbg search": "tests/test_kdbg_static_search.py",
...
MCP_EXCLUSION_UNIT_TESTS: dict[str, str] = {
    ...
    "kdbg_search": "tests/test_kdbg_static_search.py",
